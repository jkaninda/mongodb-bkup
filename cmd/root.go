...
var rootCmd = &cobra.Command{
	Use:     "mongodb-bkup",
	Short:   "MongoDB Backup tool, backup database to S3 or Object Storage",
	Long:    `MongoDB backup and restoration tool. Backup database to AWS S3 storage or any S3 Alternatives for Object Storage.`,
	Version: appVersion,
}
var operation = ""
var s3Path = "/mongodb-bkup"
...
func init() {
	...
	rootCmd.PersistentFlags().IntP("port", "p", 27017, "Set database port")
